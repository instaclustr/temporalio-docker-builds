...
: "${CASSANDRA_ADDRESS_TRANSLATOR_OPTIONS_CLI:=}"
...
wait_for_cassandra() {
    ...
    export CASSANDRA_ADDRESS_TRANSLATOR=${CASSANDRA_ADDRESS_TRANSLATOR}
    export CASSANDRA_ADDRESS_TRANSLATOR_OPTIONS=${CASSANDRA_ADDRESS_TRANSLATOR_OPTIONS}
    export CASSANDRA_ADDRESS_TRANSLATOR_OPTIONS_CLI=${CASSANDRA_ADDRESS_TRANSLATOR_OPTIONS_CLI}
